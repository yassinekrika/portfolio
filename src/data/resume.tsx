...
export const DATA = {
  ...
  locationLink: "",
  description: "Software Engineer who loves building innovative solutions and empowering others through technology.",
  ...
  skills: [
    ...
    'HTML5', 'CSS3', 'SCSS', 'Git', 'Tailwind Css', 'Angular', 'React', 'Next Js', 'Hardhat',
    'Node Js', 'Express Js',
  ...
  projects: [
    ...
    },
    {
      ...
      links: [
        {
          type: "Figma",
          href: "https://www.figma.com/design/UyTe8OBlIbN2209VPdrjEv/Blogger-Tool?m=auto&t=RroTdGHXFZavE3u1-6",
    ...
    },
    {
      ...
      dates: "Jun 2023",
      active: true,
      description: 'Siplify your reading with Summzie, an open-source article summarizer that transforms lengthy articles into clear and concise summaries',
      technologies: [
        "React",
        "Vite",
        "Html",
    ...
    },
    {
      ...
      links: [
        {
          type: "Figma",
          href: "https://www.figma.com/design/KXcFnAHMNCdZlfMAxZPIjV/e-commerce-wesite?m=auto&t=RroTdGHXFZavE3u1-6",
          icon: <Icons.figma className="size-3" />,
        },
        {
          type: "Website",
    ...
    },
    {
      ...
      dates: "October 2022",
      active: true,
      description: 'We developed an open-source online application that tracks the space station and accurately represents the Earth, the orbit of the station, and the station itself in three dimensions.',
      technologies: [
        "Web Pack",
        "JavaScript",
        "Html",
    ...
    },
    {
      ...
      dates: "October 2022",
      active: true,
      description: 'We developed an Android application and a chrome extension powered with Chat gpt Api to response automatically for emails and a voice chatbot to let users ineract with the Ai.',
      technologies: [
          "Flutter",
          "Html",
          "Css",
      ...
      links: [
        {
          type: "Figma",
          href: "https://www.figma.com/design/q9oAiowFNE29ml6r3M7664/junction-app?m=auto&t=RroTdGHXFZavE3u1-6",
          icon: <Icons.figma className="size-3" />,
        }
      ],
      image: "",
